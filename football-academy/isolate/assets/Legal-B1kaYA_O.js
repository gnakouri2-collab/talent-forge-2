import{j as e}from"./framer-motion-mb3-JiSz.js";import{u as a,L as r}from"./react-vendor-yijSofTl.js";import{P as l}from"./PageLayout-D3POaUmo.js";import{S as c}from"./Footer-DrJDu7Ga.js";import"./index-D5p-gCGT.js";import"./radix-ui-DgvWngr2.js";import"./mail-STJKTWtz.js";const s={"/mentions-legales":{title:"Mentions légales",content:`Africa Football Academy est une association loi 1901 dont le siège social est situé à Dakar, Sénégal.
...
L'Académie se réserve le droit de modifier le contenu de son site à tout moment sans préavis.`},"/confidentialite":{title:"Politique de confidentialité",content:`Africa Football Academy s'engage à protéger la vie privée des utilisateurs de son site web.
...
Cookies : Ce site peut utiliser des cookies pour améliorer l'expérience utilisateur. Vous pouvez les désactiver dans les paramètres de votre navigateur.`},"/cgu":{title:"Conditions Générales d'Utilisation",content:`Les présentes CGU régissent l'utilisation du site Africa Football Academy.
...
L'Académie se réserve le droit de modifier les présentes CGU à tout moment.`},"/politique-dons":{title:"Politique de dons",content:`Africa Football Academy est reconnaissante de chaque contribution reçue.
...
Projets de financement : Les montants collectés pour un projet spécifique sont exclusivement affectés à ce projet. En cas de non-atteinte de l'objectif, les fonds seront réalloués à un projet similaire ou remboursés selon les modalités communiquées.`}};function x(){const i=a(),t=s[i.pathname]||s["/mentions-legales"];return e.jsx(l,{title:t.title,children:e.jsx("section",{className:"py-24 bg-white",children:e.jsx("div",{className:"max-w-3xl mx-auto px-4 sm:px-6 lg:px-8",children:e.jsxs(c,{children:[e.jsx("div",{className:"prose prose-gray max-w-none",children:t.content.split(`

`).map((n,o)=>e.jsx("p",{className:"text-gray-600 leading-relaxed mb-4",children:n},o))}),e.jsx("div",{className:"mt-12 pt-8 border-t border-gray-200",children:e.jsx(r,{to:"/",className:"text-[#0B8F55] font-semibold text-sm hover:underline",children:"← Retour à l'accueil"})})]})})})})}export{x as default};
